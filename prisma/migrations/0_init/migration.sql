...
-- CreateEnum
CREATE TYPE "LanguagePreference" AS ENUM ('ARABIC', 'ENGLISH', 'URDU');
...
-- CreateEnum
CREATE TYPE "CrmClassification" AS ENUM ('LEAD', 'PROSPECT', 'CUSTOMER', 'SUPPLIER', 'PARTNER', 'INVESTOR', 'OTHER_STAKEHOLDER');
...
CREATE TABLE "Entity" (
    ...
    "entitySubtype" "EntitySubtype" NOT NULL,
    "companyName" TEXT NOT NULL,
    "contactPerson" TEXT,
    "contactRole" TEXT,
    "contactEmail" TEXT,
    "contactPhone" TEXT,
    "languagePreference" "LanguagePreference" NOT NULL DEFAULT 'ARABIC',
    "location" TEXT,
    "industrySegment" TEXT,
    "relationshipStatus" "EntityRelationshipStatus" NOT NULL DEFAULT 'NEW',
    "source" "EntitySource" NOT NULL,
    "sourceDetail" TEXT,
    "pilotStatus" "PilotStatus",
    "crmClassification" "CrmClassification" NOT NULL DEFAULT 'LEAD',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Validation" (
    ...
    "needs" TEXT[],
    "feedback" TEXT,
    "feedbackLanguage" TEXT,
    "willingnessToPay" "WtpRange",
    "commissionAcceptance" "CommissionAcceptance",
    "adoptionInterest" "AdoptionInterest",
    "firstTransactionReady" BOOLEAN NOT NULL DEFAULT false,
    "ftOrderValue" DOUBLE PRECISION,
    "assumptionResults" JSONB,
...
CREATE TABLE "LeadScoring" (
    ...
    "totalLeadScore" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "tier" TEXT NOT NULL DEFAULT 'Cold',
    "scoredDate" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "Consent" (
    ...
    "consentDate" TIMESTAMP(3),
    "consentVersion" TEXT,
    "language" "LanguagePreference" NOT NULL DEFAULT 'ARABIC',
...
CREATE TABLE "Relationship" (
    ...
    "status" "EntityLinkStatus" NOT NULL DEFAULT 'ACTIVE',
    "notes" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateTable
CREATE TABLE "AiExtractionVersion" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "AiExtractionVersion_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "Entity_entitySubtype_idx" ON "Entity"("entitySubtype");

-- CreateIndex
CREATE INDEX "Entity_crmClassification_idx" ON "Entity"("crmClassification");

-- CreateIndex
CREATE INDEX "Entity_relationshipStatus_idx" ON "Entity"("relationshipStatus");

-- CreateIndex
CREATE INDEX "Entity_source_idx" ON "Entity"("source");
...
-- CreateIndex
CREATE UNIQUE INDEX "Validation_validationId_key" ON "Validation"("validationId");

-- CreateIndex
CREATE UNIQUE INDEX "Validation_entityId_key" ON "Validation"("entityId");

-- CreateIndex
CREATE UNIQUE INDEX "LeadScoring_scoreId_key" ON "LeadScoring"("scoreId");

-- CreateIndex
CREATE UNIQUE INDEX "LeadScoring_entityId_key" ON "LeadScoring"("entityId");

-- CreateIndex
CREATE UNIQUE INDEX "Consent_consentId_key" ON "Consent"("consentId");

-- CreateIndex
CREATE UNIQUE INDEX "Consent_entityId_key" ON "Consent"("entityId");

-- CreateIndex
CREATE UNIQUE INDEX "Relationship_relationshipId_key" ON "Relationship"("relationshipId");
...
-- CreateIndex
CREATE INDEX "AiQuota_orgId_month_idx" ON "AiQuota"("orgId", "month");

-- CreateIndex
CREATE UNIQUE INDEX "AiQuota_orgId_month_key" ON "AiQuota"("orgId", "month");

-- CreateIndex
CREATE UNIQUE INDEX "AiExtractionVersion_version_key" ON "AiExtractionVersion"("version");
...
-- AddForeignKey
ALTER TABLE "Interaction" ADD CONSTRAINT "Interaction_entityId_fkey" FOREIGN KEY ("entityId") REFERENCES "Entity"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Validation" ADD CONSTRAINT "Validation_entityId_fkey" FOREIGN KEY ("entityId") REFERENCES "Entity"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LeadScoring" ADD CONSTRAINT "LeadScoring_entityId_fkey" FOREIGN KEY ("entityId") REFERENCES "Entity"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Consent" ADD CONSTRAINT "Consent_entityId_fkey" FOREIGN KEY ("entityId") REFERENCES "Entity"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
