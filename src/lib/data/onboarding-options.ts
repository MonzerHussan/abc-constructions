...
export const accountTypeOptions: AccountTypeOption[] = [
  ...
  {
    id: "mainContractor",
    key: "obTypeMainContractor",
    descKey: "obTypeMainContractorDesc",
    icon: HardHat,
  },
  {
    id: "subcontractor",
    key: "obTypeSubcontractor",
    descKey: "obTypeSubcontractorDesc",
    icon: Wrench,
  },
  {
    id: "consultant",
    key: "obTypeConsultant",
    descKey: "obTypeConsultantDesc",
    icon: FileText,
  },
  {
    id: "clientInvestor",
    key: "obTypeClientInvestor",
    descKey: "obTypeClientInvestorDesc",
    icon: Landmark,
  },
];
