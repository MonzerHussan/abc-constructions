...
import { cn, isUsableMediaUrl } from "@/lib/utils"
    ...
    >
      ...
      >
        {slides.map((slide) => {
          ...
          const isVideo = stype === "video" && isUsableMediaUrl(slide.videoUrl)
          const isText = stype === "text"
          const imageUrl = isUsableMediaUrl(slide.imageUrl) ? slide.imageUrl.trim() : null
          const posterUrl = isUsableMediaUrl(slide.posterUrl)
