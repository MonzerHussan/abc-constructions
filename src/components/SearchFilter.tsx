    ...
    <div className="space-y-3">
      <div className="flex gap-2">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 border border-surface-300 rounded-xl text-sm font-medium text-surface-700 hover:bg-surface-50"
        >
      ...
      {showFilters && (
        <div className="bg-surface-50 rounded-xl p-4 flex flex-wrap gap-4 items-end">
          {categories.length > 0 && (
