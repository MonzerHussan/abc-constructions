...
export default function AdminProcurementPage() {
  ...
  const cards = [
    { label: "طلبات الشراء", labelEn: "Purchase Requests", value: stats.totalPRs, icon: FileText, color: "bg-info-50 text-info-600", href: "/procurement/purchase-requests" },
    { label: "بانتظار الموافقة", labelEn: "Pending Approval", value: stats.pendingPRs, icon: Send, color: "bg-amber-50 text-amber-600", href: "/procurement/purchase-requests?status=PENDING_APPROVAL" },
    { label: "طلبات عروض الأسعار", labelEn: "RFQs", value: stats.totalRFQs, icon: Package, color: "bg-success-50 text-success-600", href: "/procurement/rfqs" },
    { label: "أوامر الشراء", labelEn: "Purchase Orders", value: stats.totalPOs, icon: ShoppingCart, color: "bg-flagship-50 text-flagship-600", href: "/procurement/purchase-orders" },
    { label: "فواتير معلقة", labelEn: "Pending Invoices", value: stats.pendingInvoices, icon: Receipt, color: "bg-danger-50 text-danger-600", href: "/procurement/invoices" },
  ...
  return (
    <div className="p-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Link href="/procurement/purchase-requests" className="bg-white border rounded-xl p-6 hover:shadow-md transition-shadow">
        ...
        <Link href="/procurement/rfqs" className="bg-white border rounded-xl p-6 hover:shadow-md transition-shadow">
          <div className="flex items-center gap-3 mb-4">
