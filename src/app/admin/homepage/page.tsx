...
const EMPTY_CONTENT: ContentForm = {
  ...
  primaryCtaLabel: "", primaryCtaLabelEn: "", primaryCtaLabelUr: "", primaryCtaHref: "/auth/register",
  secondaryCtaLabel: "", secondaryCtaLabelEn: "", secondaryCtaLabelUr: "", secondaryCtaHref: "/tenders/projects",
  isActive: true,
}
...
export default function AdminHomepagePage() {
    ...
    if (res.ok) {
      ...
      if (data.content) {
        ...
        setContent({
          ...
          primaryCtaLabel: c.primaryCtaLabel ?? "", primaryCtaLabelEn: c.primaryCtaLabelEn ?? "", primaryCtaLabelUr: c.primaryCtaLabelUr ?? "", primaryCtaHref: c.primaryCtaHref ?? "/auth/register",
          secondaryCtaLabel: c.secondaryCtaLabel ?? "", secondaryCtaLabelEn: c.secondaryCtaLabelEn ?? "", secondaryCtaLabelUr: c.secondaryCtaLabelUr ?? "", secondaryCtaHref: c.secondaryCtaHref ?? "/tenders/projects",
  ...
  async function saveItem(resource: "slides" | "videos" | "ads", id: string | undefined, payload: any, method: string) {
    setSaving(true)
    const url = id
      ? `/api/admin/homepage/${resource}/${id}`
      : `/api/admin/homepage/${resource}`
  ...
  async function deleteItem(resource: "slides" | "videos" | "ads", id: string) {
    await fetch(`/api/admin/homepage/${resource}/${id}`, { method: "DELETE" })
    await load()
  }
