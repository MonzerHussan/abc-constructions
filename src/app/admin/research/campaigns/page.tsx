    ...
    <div className="p-6">
      ...
      {loading ? (
        ...
        <div className="text-center py-12 text-surface-500">
          ...
          <Link href="/admin/research/campaigns/new" className="text-info-600 hover:underline mt-2 inline-block">إنشاء أول حملة</Link>
        </div>
      ) : (
            ...
            <tbody>
              {campaigns.map((campaign) => (
                <tr key={campaign.id} className="border-b last:border-0 hover:bg-surface-50">
                  <td className="p-4">
                    <Link href={`/admin/research/campaigns/${campaign.id}`} className="font-semibold text-info-600 hover:underline">
                      {campaign.title}
                    </Link>
                  ...
                  <td className="p-4">
                    <div className="flex items-center justify-center gap-2">
                      <Link href={`/admin/research/campaigns/${campaign.id}`} className="p-1.5 text-info-600 hover:bg-info-50 rounded-lg"><Eye size={18} /></Link>
                      <Link href={`/admin/research/campaigns/${campaign.id}/edit`} className="p-1.5 text-success-600 hover:bg-success-50 rounded-lg"><Edit size={18} /></Link>
