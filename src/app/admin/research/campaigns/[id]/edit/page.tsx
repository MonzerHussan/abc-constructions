...
export default function EditCampaignPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      router.push(`/admin/research/campaigns/${params.id}`)
    ...
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="bg-white border rounded-xl p-6 space-y-5">
        ...
        <div className="flex items-center gap-3 pt-4 border-t">
          ...
          <Link href={`/admin/research/campaigns/${params.id}`} className="px-6 py-2.5 border rounded-lg hover:bg-surface-50">إلغاء</Link>
        </div>
      </form>
    </div>
  )
