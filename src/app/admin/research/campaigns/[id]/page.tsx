...
export default function CampaignDetailPage() {
  ...
  async function deleteCampaign() {
    ...
    router.push("/admin/research/campaigns")
  }
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <div className="flex items-center gap-2 mb-6">
        <Link href="/admin/research/campaigns" className="text-surface-500 hover:text-surface-700"><ArrowRight size={20} /></Link>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white border rounded-xl p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href={`/admin/research/campaigns/${campaign.id}/surveys`} className="flex items-center gap-1 text-info-600 text-sm hover:underline"><Plus size={16} /> إضافة استبيان</Link>
            </div>
            {campaign.surveys.length === 0 ? (
              ...
              <div className="space-y-2">
                {campaign.surveys.map((survey) => (
                  <Link key={survey.id} href={`/admin/research/campaigns/${campaign.id}/surveys/${survey.id}`} className="flex items-center justify-between p-3 border rounded-lg hover:bg-surface-50">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border rounded-xl p-6">
            ...
            <div className="space-y-2">
              ...
              <Link href={`/admin/research/campaigns/${campaign.id}/edit`} className="w-full flex items-center gap-2 px-4 py-2 border rounded-lg hover:bg-surface-50 text-sm"><Edit size={16} /> تعديل الحملة</Link>
