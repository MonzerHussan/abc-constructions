  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-8">
        ...
        <Link href="/admin/research/campaigns/new" className="flex items-center gap-2 bg-info-600 text-white px-4 py-2 rounded-lg hover:bg-info-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <Link href="/admin/research/campaigns" className="bg-white border rounded-xl p-6 hover:shadow-md transition">
        ...
        <Link href="/admin/research/participants" className="bg-white border rounded-xl p-6 hover:shadow-md transition">
        ...
        <Link href="/admin/research/founding-members" className="bg-white border rounded-xl p-6 hover:shadow-md transition">
        ...
        <Link href="/admin/research/feature-requests" className="bg-white border rounded-xl p-6 hover:shadow-md transition">
        ...
        <Link href="/admin/research/feedback" className="bg-white border rounded-xl p-6 hover:shadow-md transition">
        ...
        <Link href="/admin/research/analytics" className="bg-white border rounded-xl p-6 hover:shadow-md transition">
        ...
        <Link href="/admin/research/ai-insights" className="bg-white border rounded-xl p-6 hover:shadow-md transition">
