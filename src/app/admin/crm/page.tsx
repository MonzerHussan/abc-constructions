...
export default function AdminCrmPage() {
  ...
  const cards = [
    { label: "إجمالي العملاء المحتملين", value: stats.totalLeads, icon: Users, color: "bg-info-500", href: "/admin/crm/leads" },
    { label: "جهات الاتصال", value: stats.totalContacts, icon: Users, color: "bg-success-500", href: "/admin/crm/contacts" },
    { label: "الفرص", value: stats.totalOpportunities, icon: Target, color: "bg-flagship-500", href: "/admin/crm/opportunities" },
    { label: "النشاطات", value: stats.totalActivities, icon: Activity, color: "bg-flagship-500", href: "/admin/crm/activities" },
    { label: "المهام المفتوحة", value: stats.openTasks, icon: CalendarCheck, color: "bg-amber-500", href: "/admin/crm/tasks" },
    { label: "الاجتماعات القادمة", value: stats.upcomingMeetings, icon: TrendingUp, color: "bg-teal-500", href: "/admin/crm/meetings" },
  ]
  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-8">
        ...
        <Link href="/admin/crm/leads/new" className="flex items-center gap-2 bg-info-600 text-white px-4 py-2 rounded-lg hover:bg-info-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <Link href="/admin/crm/leads" className="bg-white border rounded-xl p-6 hover:shadow-md transition">
        ...
        <Link href="/admin/crm/contacts" className="bg-white border rounded-xl p-6 hover:shadow-md transition">
        ...
        <Link href="/admin/crm/opportunities" className="bg-white border rounded-xl p-6 hover:shadow-md transition">
