...
export default function OrgDetailPage() {
  ...
  const tabs = [
    { href: `/organization/${id}/members`, icon: Users, label: "الأعضاء", desc: "إدارة أعضاء الفريق والصلاحيات" },
    { href: `/organization/${id}/roles`, icon: Shield, label: "الأدوار", desc: "إدارة الأدوار والصلاحيات" },
    { href: `/organization/${id}/verifications`, icon: Settings, label: "التوثيق", desc: "توثيق المؤسسة والمستندات" },
  ]
