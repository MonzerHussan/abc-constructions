    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <Card className="p-4">
            <p className="text-sm text-gray-500">{t("openTenders")}</p>
            <p className="text-2xl font-bold text-green-600">42</p>
          </Card>
          <Card className="p-4">
            <p className="text-sm text-gray-500">{t("totalBids")}</p>
            <p className="text-2xl font-bold text-blue-600">186</p>
          </Card>
          <Card className="p-4">
            <p className="text-sm text-gray-500">{t("awardedTenders")}</p>
            <p className="text-2xl font-bold text-purple-600">28</p>
          </Card>
          <Card className="p-4">
            <p className="text-sm text-gray-500">{t("projectOwners")}</p>
              ...
              <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-3 text-sm">
                    ...
                    <span className="text-gray-500">{tender.user.company}</span>
                    <span className="text-gray-400">|</span>
