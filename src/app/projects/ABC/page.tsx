...
const CREATE_ACCOUNT_ROLES: { href: string; labelKey: TranslationKey }[] = [
  { href: "/projects/ABC/auth/register", labelKey: "accountCategoryEntity" },
  { href: "/projects/ABC/auth/register", labelKey: "accountCategoryCompany" },
  { href: "/projects/ABC/auth/register", labelKey: "accountCategoryOwner" },
  { href: "/projects/ABC/auth/register", labelKey: "accountCategoryConsultant" },
  { href: "/projects/ABC/auth/register", labelKey: "accountCategoryContractor" },
  { href: "/projects/ABC/auth/register", labelKey: "accountCategorySubcontractor" },
  { href: "/projects/ABC/auth/register", labelKey: "accountCategorySupplier" },
  { href: "/projects/ABC/auth/register", labelKey: "accountCategoryTrader" },
        ...
        >
          {loggedIn ? (
            <>
              ...
              <hr className="my-1" />
              <button onClick={() => signOut({ callbackUrl: "/" })} className="flex items-center gap-2 px-4 py-2 text-sm text-danger-600 hover:bg-danger-50 w-full transition-colors">
...
export default function HomePage() {
  ...
  // Left-column admin zone (localized object from the API, or raw-field fallback)
  ...
  return (
    <div className="min-h-screen bg-surface-50" dir={dir}>
        ...
        <div className="relative flex flex-col gap-1 py-2 lg:py-0 lg:min-h-0">
          ...
          <div className="grid flex-1 gap-1 lg:min-h-0 lg:grid-cols-[1fr_280px]">
            ...
            <div className="relative flex flex-col gap-1 lg:min-h-0 flex-1">
              <RectPanel
                label={language === "en" ? "Media" : "وسائط"}
                dir={dir}
                className="flex-1 lg:min-h-0 gradient-hero rounded-none border-0"
              >
              ...
              {data.ads.length > 0 && (
                <div className="shrink-0">
                  <div className={`grid gap-1 ${adGridClass(data.ads.length)}`}>
      ...
      {/* Videos grid */}
      {below.showVideosSection && data.videos.length > 0 && (
        <section className="py-6">
          <div className="max-w-7xl mx-auto px-2 sm:px-3 lg:px-4">
