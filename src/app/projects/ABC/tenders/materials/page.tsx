  ...
  return (
    <div className="min-h-screen bg-surface-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            { label: t("tendersTitle"), href: "/projects/ABC/tenders" },
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-surface-900 flex items-center gap-2">
              <Package className="w-7 h-7 text-success-600" />
          ...
          <Link
            href="/projects/ABC/tenders/materials/new"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <Card className="p-4">
            <p className="text-sm text-surface-500">{t("activeRequests")}</p>
            <p className="text-2xl font-bold text-success-600">35</p>
          </Card>
          <Card className="p-4">
            <p className="text-sm text-surface-500">{t("submittedBids")}</p>
            <p className="text-2xl font-bold text-info-600">142</p>
          </Card>
          <Card className="p-4">
            <p className="text-sm text-surface-500">{t("estimatedSavings")}</p>
            <p className="text-2xl font-bold text-amber-600">15%</p>
          </Card>
          <Card className="p-4">
            <p className="text-sm text-surface-500">{t("activeSuppliers")}</p>
            <p className="text-2xl font-bold text-flagship-600">68</p>
          </Card>
        </div>
            ...
            <Card key={tender.id} hover className="p-6">
              <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
                ...
                <div className="flex flex-col gap-2 lg:min-w-[140px]">
                  <Link
                    href={`/projects/ABC/tenders/materials/${tender.id}`}
                    className="flex items-center justify-center gap-2 px-4 py-2.5 bg-navy-800 text-white rounded-xl text-sm font-medium hover:bg-navy-900 transition-colors"
                  >
