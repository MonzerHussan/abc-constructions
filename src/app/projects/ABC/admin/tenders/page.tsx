  ...
  return (
    <div className="p-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Link href="/projects/ABC/tenders/projects" className="flex items-center gap-4 p-6 bg-white border rounded-xl hover:shadow-md transition-shadow">
        ...
        <Link href="/projects/ABC/tenders/materials" className="flex items-center gap-4 p-6 bg-white border rounded-xl hover:shadow-md transition-shadow">
          <div className="w-12 h-12 bg-amber-50 rounded-xl flex items-center justify-center">
