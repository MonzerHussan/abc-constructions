  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-6">
        ...
        <Link href="/projects/ABC/procurement/rfqs/new" className="flex items-center gap-2 px-4 py-2 bg-amber-500 text-white rounded-lg hover:bg-amber-600 transition-colors text-sm">
      ...
      {loading ? (
        ...
        <div className="text-center py-16 border-2 border-dashed border-surface-200 rounded-2xl">
          ...
          <Link href="/projects/ABC/procurement/rfqs/new" className="inline-flex items-center gap-2 px-6 py-3 bg-amber-500 text-white rounded-xl hover:bg-amber-600"><Plus className="w-5 h-5" />{t("createRfq")}</Link>
        </div>
      ) : (
        <>
