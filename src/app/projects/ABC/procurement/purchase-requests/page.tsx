  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-6">
        ...
        <Link
          href="/projects/ABC/procurement/purchase-requests/new"
      ...
      {loading ? (
        ...
        <div className="text-center py-16 border-2 border-dashed border-surface-200 rounded-2xl">
          ...
          <Link href="/projects/ABC/procurement/purchase-requests/new" className="inline-flex items-center gap-2 px-6 py-3 bg-amber-500 text-white rounded-xl hover:bg-amber-600">
        ...
        <>
          <div className="bg-white border rounded-xl overflow-hidden">
            ...
            {data.items.map((pr: any) => (
              <Link key={pr.id} href={`/projects/ABC/procurement/purchase-requests/${pr.id}`} className="block md:grid md:grid-cols-12 gap-4 px-6 py-4 border-b hover:bg-surface-50 transition-colors">
