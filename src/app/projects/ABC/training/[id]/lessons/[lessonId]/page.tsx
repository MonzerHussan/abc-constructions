      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { label: courseTitle, href: `/projects/ABC/training/${course.id}` },
            { label: lessonTitle },
          ]}
        />
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 pt-4 border-t border-surface-200">
              <div className="flex gap-3">
                {prevLesson ? (
                  <Link
                    href={`/projects/ABC/training/${course.id}/lessons/${prevLesson.id}`}
                ...
                {nextLesson ? (
                  <Link
                    href={`/projects/ABC/training/${course.id}/lessons/${nextLesson.id}`}
                    className="inline-flex items-center gap-2 px-4 py-2.5 border border-surface-200 rounded-lg text-sm font-medium text-surface-700 hover:bg-surface-50 transition-colors"
                  >
                ...
                <div className="max-h-[calc(100vh-300px)] overflow-y-auto">
                  {allLessons.map((l, i) => {
                    ...
                    return (
                      <Link
                        key={l.id}
                        href={`/projects/ABC/training/${course.id}/lessons/${l.id}`}
